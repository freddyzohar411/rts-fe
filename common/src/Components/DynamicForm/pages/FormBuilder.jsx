...
import DroppableList from "../components/formbuilder/DroppableList";
...
import FormElementSidebar from "../components/formbuilder/FormElementSidebar";
import DnDWrapper from "../components/dragndrop/DnDWrapper";
import {
...
const FormBuilder = ({ onSubmit, userDetails, template, fields, onSave }) => {
  ...
  const handleSaveJsonAPI = async () => {
    ...
    if (onSave) {
      await onSave(formName, formFields, formLayoutSchema, formState);
      return;
    } else {
      const JSONData = {
        formName: formName,
