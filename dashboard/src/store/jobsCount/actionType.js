...
export const TOTAL_ASSIGNED_JOBS_COUNT = "TOTAL_ASSIGNED_JOBS_COUNT";
export const TOTAL_ASSIGNED_JOBS_COUNT_SUCCESS =
  "TOTAL_ASSIGNED_JOBS_COUNT_SUCCESS";
export const TOTAL_ASSIGNED_JOBS_COUNT_FAILURE =
  "TOTAL_ASSIGNED_JOBS_COUNT_FAILURE";

export const TOTAL_FOD_JOBS_COUNT = "TOTAL_FOD_JOBS_COUNT";
export const TOTAL_FOD_JOBS_COUNT_SUCCESS = "TOTAL_FOD_JOBS_COUNT_SUCCESS";
export const TOTAL_FOD_JOBS_COUNT_FAILURE = "TOTAL_FOD_JOBS_COUNT_FAILURE";
