              ...
              <Col lg={6}>
                <div className="mb-3">
                  ...
                  <p className="text-muted">
                    (Users that are selected here will be auto populated in
                    "Assigned To" field while posting the job.)
                  </p>
                </div>
              </Col>
              <Col lg={6}>
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  ...
                  <p className="text-muted">
                    (Users that are selected here will be auto populated in
                    "Sales Manager" field while posting the job.)
                  </p>
                </div>
              </Col>
              <Col lg={6}>
                <div className="mb-3">
                  <Field name="teamLead">
                    {({ field }) => (
                      <select id="teamLead" className="form-select" {...field}>
                        <option value="">Select</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  ...
                  <p className="text-muted">
                    (Users that are selected here will be auto populated in
                    "Account Manager" field while posting the job.)
                  </p>
                </div>
              </Col>
              <Col lg={6}>
                <div className="mb-3">
                  <Field name="salesName">
                    {({ field }) => (
                      <select className="form-select" id="salesName" {...field}>
                        <option value="">Select</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
            ...
            <Row>
              <Col lg={6}>
                <div className="mb-3">
                  ...
                  <p className="text-muted">
                    (Users that are selected here will be auto populated in
                    "Recruitment Manager" field while posting the job.)
                  </p>
                </div>
              </Col>
              <Col lg={6}>
