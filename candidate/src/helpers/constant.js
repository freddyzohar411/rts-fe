...
export const candidateModuleURL = {
  ...
  candidate_certification: `${PortURL.CANDIDATE_URL}${BaseURL.BASE_CERTIFICATE}`,
  candidate_languages: `${PortURL.CANDIDATE_URL}${BaseURL.BASE_LANGUAGES}`,
  candidate_employer_details: `${PortURL.CANDIDATE_URL}${BaseURL.BASE_EMPLOYER_DETAILS}`,
};
