...
const JOB_STAGE_IDS = {
  ...
  FIRST_INTERVIEW_SCHEDULED: 6,
  SECOND_INTERVIEW_SCHEDULED: 7,
  THIRD_INTERVIEW_SCHEDULED: 8,
  INTERVIEW_FEEDBACK_PENDING: 9,
  CONDITIONAL_OFFER: 10,
  CONDITIONAL_OFFER_SENT: 11,
};
